 ...
 */
public abstract class SelfRemovingMainSwitchPreference extends MainSwitchPreference {

    private final ConstraintsHelper mConstraints;

    public SelfRemovingMainSwitchPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mConstraints = new ConstraintsHelper(context, attrs, this);
        setPreferenceDataStore(new DataStore());
    }

    public SelfRemovingMainSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mConstraints = new ConstraintsHelper(context, attrs, this);
        setPreferenceDataStore(new DataStore());
    }

    public SelfRemovingMainSwitchPreference(Context context) {
        super(context);
    ...
    private class DataStore extends PreferenceDataStore {
        ...
        public void putBoolean(String key, boolean value) {
            SelfRemovingMainSwitchPreference.this.putBoolean(key, value);
        }

        @Override
        public boolean getBoolean(String key, boolean defaultValue) {
            return SelfRemovingMainSwitchPreference.this.getBoolean(key, defaultValue);
        }
    }
}
